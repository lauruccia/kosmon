...
**AGGIORNATO IL 2026-07-20, CORRETTO IL 2026-07-22** (decisioni di Laura, "slide letterale" — sostituisce la breakaway del 2026-07-03 che si fermava al primo Top+ incontrato): il testo della slide "Compensi indiretti estesi" ("il TOP percepisce provvigioni dello 0,5% ... per un numero illimitato di livelli e fino al 5° livello del TOP seguente") si applica alla lettera, con questa precisazione (22/07): il blocco è **per grado PARI O SUPERIORE** al beneficiario — un Top è bloccato da Top, SuperVisor e Manager; un grado **inferiore** NON blocca (un Top non ferma un SuperVisor; gerarchia Top < SuperVisor < Manager). Il conteggio non si ferma AL nodo bloccante ma prosegue fino a **5 livelli sotto** il primo grado pari-o-superiore incontrato lungo il ramo (il suo "5° livello", incluso). I livelli 1-5 del beneficiario pagano **sempre a tabella piena** (4/2/1/0,5/8%), anche se il bloccante sta nei primi 5 livelli: es. pari grado al 2° livello → tabella su 1-5, poi 0,5% al 6° e 7°, stop dall'8°; pari grado al 7° → tabella su 1-5, 0,5% dal 6° al 12°. Senza grado pari o superiore nel ramo la discesa è illimitata.
