...
class NotificationPreferencesController extends Controller
{
    ...
    public static function events(): array
    {
        return [
            ...
            'payment_plan_proposed'   => ['label' => 'Piano rateale proposto',              'default' => ['database', 'mail']],
            'payment_plan_approved'   => ['label' => 'Piano rateale approvato/rifiutato',   'default' => ['database', 'mail']],
            'netting_proposed'        => ['label' => 'Compensazione proposta',              'default' => ['database', 'mail']],
            'netting_accepted'        => ['label' => 'Compensazione accettata/rifiutata',   'default' => ['database', 'mail']],
            'text_request_sent'       => ['label' => 'Richiesta pagamento testuale',        'default' => ['database', 'mail']],
            'text_request_approved'   => ['label' => 'Richiesta testo approvata/rifiutata', 'default' => ['database', 'mail']],
