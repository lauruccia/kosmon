 ...
 *   (dal 2026-07-27 si aggiunge per ogni grado il minimo di PUNTI DA
 *   RICARICHE, richiesta di Laura: default Basic 6, Key 12, Senior/Top/
 *   SuperVisor/Manager 24 — vedi migration 2026_07_27_120000, editabile
 *   da admin come tutti gli altri requisiti)
...
class MlmRankEngine
{
    ...
    private const METRIC_TO_REQUIREMENT_FIELD = [
        ...
        'deposit_points' => 'min_deposit_points',
    ...
    private const RANK_LABELS = [
        ...
        'min_deposit_points' => 'Punti da ricariche',
     ...
     * - 'deposit_points' => punti attivi generati da ricariche (2026-07-27)
    ...
    public function evaluate(User $agent): array
    {
        ...
        // Punti da RICARICHE (2026-07-27, richiesta di Laura, punto 4):
        // sottoinsieme dei punti attivi (stessa finestra valid_from/
        // valid_until di mlmActivePoints()) generati SPECIFICAMENTE da
        // ricariche (source_type = 'deposit' in MlmPointsService::
        // awardDepositPoints()), non dall'apertura conto ne' da altri
        // eventi futuri. A differenza delle altre metriche non include
        // punti "omaggio" (nessuna metrica MlmMetricGrant dedicata): un
        // requisito pensato per misurare ricariche reali non deve poter
        // essere aggirato con un regalo amministrativo.
        $depositPoints = max(0, mlm_points_normalize((float) $agent->mlmPointLedgerEntries()
