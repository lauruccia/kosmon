...
class MenuVisibility extends Model
{
    ...
    public static function menuItems(): array
    {
        return [
            ...
            // "Invia KY" (gruppo Paga): prima del 14/08/2026 questa voce era erroneamente
            // agganciata alla chiave 'rate', quindi spegnere "Rate" nascondeva anche l'invio KY.
            'paga'               => 'Invia KY',
            ...
            'help'               => 'Assistenza',
            // ── AREA AGENTI MLM (visibile solo se kmoney.mlm_enabled) ───
            'mlm-agent-request'  => 'Lavora con noi',
            'mlm-agent-contract' => 'Il mio contratto (agente)',
            'mlm-struttura'      => 'La mia struttura',
            'mlm-clienti'        => 'I miei clienti',
            'mlm-company-reports' => 'Segnalazioni aziende (agente)',
            'mlm-invitati'       => 'I miei inviti',
            'mlm-registra-agente' => 'Registra agente',
            'mlm-guadagni'       => 'I miei guadagni',
            'mlm-prelievi'       => 'Prelievi',
            'mlm-payment-details' => 'Dati bancari KNM',
            // ── SEZIONE UTENTE (in fondo alla sidebar) ──────────────────
            'profile'            => 'Profilo azienda',
            'profilo-personale'  => 'Il mio profilo (privati)',
            'security'           => 'Sicurezza',
            'login-logs'         => 'Accessi',
