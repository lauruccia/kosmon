...
class SystemSetting extends Model
{
    ...
    {
        return <<<'HTML'
<p><strong>Kosmos — Contratto di adesione al Circuito KSM</strong></p>
<p>Il Gestore del Circuito è <strong>Kosmos</strong>, con sede legale in C.so Vittorio Emanuele II, 36 — 62032 Camerino (MC), C.F./P.IVA 01768560433, Reg. Imprese MC-179933, Codice Univoco M5UXCR1, PEC e contatti come indicati sul Portale. Con la sottoscrizione della richiesta di adesione il Cliente dichiara di aver letto e accettato integralmente le seguenti condizioni generali.</p>

<h2>Informativa e consenso ai sensi del D.Lgs 196/03</h2>
<p>In relazione ai trattamenti di dati personali conseguenti l'esecuzione del presente contratto, Kosmos, Titolare ai sensi del D.Lgs 196/03, precisa quanto segue:</p>
...
d) Titolare del trattamento dei dati è Kosmos, avente sede legale a Camerino in C.so Vittorio Emanuele II, 36 — 62032, presso cui si potrà rivolgere in qualunque momento per l'esercizio dei suoi diritti ai sensi dell'articolo 7 del D.Lgs 196/03: diritto in qualunque momento di ottenere la conferma dell'esistenza o meno dei medesimi dati, di conoscerne il contenuto, l'origine, di verificarne l'esattezza e/o chiederne l'integrazione e/o l'aggiornamento, oppure la rettificazione.</p>

<hr>
<p><strong>Condizioni generali del contratto di fornitura servizi</strong></p>

<h2>Art. 1 – Termini e condizioni</h2>
<p>Nel testo del presente contratto si intende indicare con il termine <strong>Kosmos</strong> il Gestore del Circuito indicato in epigrafe, domiciliato presso la propria sede legale, che gestisce l'intero Circuito KSM. <strong>KSM</strong>: il Circuito che permette ai propri Clienti di effettuare acquisti e vendite anche con il meccanismo degli scambi multilaterali attraverso operazioni in compensazione. <strong>Portale</strong>: il sito del Circuito. <strong>Cliente</strong>: la persona fisica o giuridica che richiede di usufruire dei servizi oggetto del presente contratto. <strong>Estratto Conto</strong>: l'insieme delle registrazioni, tenute a cura di Kosmos, degli acquisti e delle vendite effettuate da ciascun Cliente all'interno del Circuito. <strong>Kmoney</strong>: l'unità di conto, il cui valore è pari ad un euro, utilizzata all'interno del Circuito per indicare il valore degli acquisti e delle vendite. <strong>App</strong>: l'applicazione che consente di fruire dei servizi offerti utilizzando telefoni cellulari smartphone.</p>
...
HTML;
    ...
    {
        return <<<'HTML'
<p><strong>Kosmos — Modulo di adesione e Condizioni Generali per l'Incaricato di Vendita</strong></p>
...
<p><strong>1.</strong> L'incaricato di vendita Kosmos (in seguito indicato come incaricato) opera ai sensi dell'art.19 dl D. Lgs.114/1998 promuovendo la vendita di beni e servizi di Kosmos. Solo l'incaricato di vendita autorizzato da Kosmos può promuovere beni e servizi di Kosmos. L'incaricato può promuovere i beni e servizi di Kosmos solo a consumatori finali.</p>
...
<p><strong>25.</strong> L'incaricato dà atto di essere stato informato da Kosmos che ogni informazione che lo stesso fornirà a Kosmos sarà conservata da Kosmos in un database elettronico e verrà utilizzata da Kosmos per scopi commerciali o amministrativi. L'incaricato dà altresì atto che Kosmos potrà rivelare tali informazioni con riferimento a tali scopi, ad altre società collegate a Kosmos sia che si trovino all'interno sia che si trovino all'esterno della UE e ad altre persone e, in particolare, potrà rivelare tali dati ad altri incaricati in quanto facenti parte dell'organizzazione di Kosmos. L'incaricato si impegna a informare per iscritto e senza ritardo Kosmos su qualsiasi cambiamento riguardante i propri dati personali comunicati a Kosmos. L'incaricato autorizza Kosmos a conservare, trattenere e rivelare tali informazioni alle condizioni sopra indicate.</p>
...
<h4>Glossario dei termini del Sito Personale Kosmos</h4>
...
<p>Kosmos offre ai potenziali Incaricati Kosmos la qualifica iniziale Start (ST). A seguire vi sono 6 qualifiche per avanzamento: Basic (KB), Key (K), Senior (KS), Top (KT), Supervisore (SPV) e Manager (MNG). Il piano compensi offre un incentivo semplice ma efficace ai fini dell'avanzamento alle qualifiche superiori: a qualifiche superiori corrispondono infatti guadagni più elevati.</p>
...
<p>Le diverse qualifiche per avanzamento all'interno della struttura Kosmos richiedono agli Incaricati di soddisfare dei requisiti aggiuntivi.</p>
