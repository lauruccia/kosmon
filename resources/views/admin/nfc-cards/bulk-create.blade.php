    ...
    <form method="POST" action="{{ route('admin.nfc-cards.bulk-store') }}">
        ...
        <div class="field-grid">
            ...
            <div class="field">
                ...
                <textarea id="notes" name="notes" placeholder="Es. Lotto giugno 2026 — chip Mifare Classic">{{ old('notes') }}</textarea>
            </div>

        </div>

        {{-- Preview contatore --}}
        <div id="bulk-preview" style="background:#f0fdf4;border:1.5px solid #bbf7d0;border-radius:10px;padding:14px 16px;margin:16px 0;font-size:13px;color:#166534;display:none;">
