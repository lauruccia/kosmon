        ...
        <article class="card light-card">
            ...
            <div class="info-grid">
                <div>
                    ...
                    <span class="copy-field" title="{{ $userRecord->email }}">
                        <strong>{{ $userRecord->email }}</strong>
                        <button type="button" class="copy-field-btn" data-copy="{{ $userRecord->email }}" aria-label="Copia email" title="Copia email"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg></button>
                    </span>
