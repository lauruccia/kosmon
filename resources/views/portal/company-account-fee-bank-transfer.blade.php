...
<div style="max-width:560px;">
    ...
    <div style="margin-bottom:24px;">
        <a href="{{ route('portal.company-account-fee.show') }}" style="font-size:13px;color:var(--teal-strong);text-decoration:none;">&larr; Torna ai metodi di pagamento</a>
    </div>
    ...
    <div class="card" style="padding:28px;">
        ...
        <div style="display:flex;align-items:center;gap:14px;margin-bottom:24px;">
            ...
            <div>
                ...
                <div style="font-size:13px;color:var(--ink-soft);margin-top:2px;">La quota risulter&agrave; saldata quando il bonifico sar&agrave; verificato, entro 1-2 giorni lavorativi.</div>
            </div>
        </div>
