...
class ShopPurchaseRegressionTest extends TestCase
{
     ...
     */
    private function makeBuyer(int $saldo = 100000, bool $conIndirizzo = true): array
    {
        $user = User::create([
            'name'                => 'Mario Rossi',
     ...
     */
    private function makeSeller(int $saldo = 0): array
    {
    ...
    private function makeGateway(Company $company): PaymentGateway
    {
     ...
     */
    private function makeListing(Company $company, int $prezzo, int $kyPercentage, array $extra = []): Listing
    {
